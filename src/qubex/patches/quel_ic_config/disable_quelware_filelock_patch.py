...
def _patch_sock_file_lockkeeper(sock_module: Any) -> None:
    ...
    dummy_lock_keeper_cls = getattr(sock_module, "DummyLockKeeper", None)
    if (
        file_lock_keeper_cls is None
        or abstract_lock_keeper_cls is None
        or dummy_lock_keeper_cls is None
    ):
        return
    ...
    file_lock_keeper_cls.has_lock = dummy_lock_keeper_cls.has_lock
    file_lock_keeper_cls._take_lock = dummy_lock_keeper_cls._take_lock
    file_lock_keeper_cls._keep_lock = dummy_lock_keeper_cls._keep_lock
    file_lock_keeper_cls._release_lock = dummy_lock_keeper_cls._release_lock
...
def _patch_coap_file_lock_client(coap_module: Any) -> None:
    ...
    dummy_lock_client_cls = getattr(
        coap_module, "SyncAsyncCoapClientWithDummyLock", None
    )
    if (
        file_lock_client_cls is None
        or abstract_coap_client_cls is None
        or dummy_lock_client_cls is None
    ):
        return
    ...
    file_lock_client_cls._take_lock = dummy_lock_client_cls._take_lock
    file_lock_client_cls._keep_lock = dummy_lock_client_cls._keep_lock
    file_lock_client_cls._release_lock = dummy_lock_client_cls._release_lock
    file_lock_client_cls._release_lock_body = dummy_lock_client_cls._release_lock_body
    file_lock_client_cls._check_lock_at_host = dummy_lock_client_cls._check_lock_at_host
    file_lock_client_cls._cleanup = dummy_lock_client_cls._cleanup
    file_lock_client_cls._cleanup_at_exit = dummy_lock_client_cls._cleanup_at_exit
