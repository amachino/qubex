...
DEFAULT_STABILITY_CORRECTION_N_SHOTS: Final[int] = 2048
DEFAULT_STABILITY_CORRECTION_PROBE_DURATION: Final[float] = 2048.0  # ns

DEFAULT_OUTPUT_GAIN_CORRECTION_MAX_RELATIVE_STEP: Final[float] = 0.1
DEFAULT_OUTPUT_GAIN_CORRECTION_SMOOTHING: Final[float] = 1.0
DEFAULT_OUTPUT_GAIN_CORRECTION_DEADBAND: Final[float] = 0.003
DEFAULT_OUTPUT_GAIN_CORRECTION_DEADBAND_SIGMA: Final[float] = 3.0
DEFAULT_OUTPUT_PHASE_CORRECTION_MAX_STEP: Final[float] = 0.5  # rad
DEFAULT_OUTPUT_PHASE_CORRECTION_SMOOTHING: Final[float] = 1.0
DEFAULT_OUTPUT_PHASE_CORRECTION_DEADBAND: Final[float] = 0.0  # rad
DEFAULT_OUTPUT_PHASE_CORRECTION_DEADBAND_SIGMA: Final[float] = 3.0
DEFAULT_OUTPUT_PHASE_MIN_RESULTANT_LENGTH: Final[float] = 0.8
