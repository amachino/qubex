...
Task-oriented guides and supporting operational references.
...
- [Skew adjustment](../reference/skew-adjustment.md)
- [Results and records](../reference/results-and-records.md)
- [State classification](../reference/state-classification.md)
