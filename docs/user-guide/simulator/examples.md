...
- [DRAG calibration](../../examples/simulator/6_drag_calibration.ipynb): Explore pulse shaping for leakage reduction.
- [CR dynamics](../../examples/simulator/7_cr_dynamics.ipynb): Inspect cross-resonance dynamics in simulation.
- [CR calibration](../../examples/simulator/8_cr_calibration.ipynb): Iterate on a two-qubit calibration workflow without hardware.
- [Jazz](../../examples/simulator/9_jazz.ipynb): Explore a more advanced simulator example.
